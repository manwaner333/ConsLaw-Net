...
class VariantCoeLinear1d(torch.nn.Module):
    ...
    def update(self):
        ...
        if max_f_prime > 0.001 and max_f_prime < 4:
...
if __name__ == "__main__":
    # experiment_name = 'N_200_example_6_dt_0.1_layer_10_beta_10'
    # experiment_name = 'N_200_example_1_dt_0.1_layer_10_beta_10_extra_test'
    # experiment_name = 'N_200_example_1_dt_0.1_layer_10_beta_10_noise'
    experiment_name = 'N_400_example_2_dt_0.1_layer_10_beta_0.5'
    ...
    # # 对数据添加一些噪音处理
    # experiment_name = 'N_200_example_3_dt_0.1_layer_10_beta_10_1'
    # real_data_file = 'data/' + experiment_name + '_U' + '.npy'
    #
