...
class VariantCoeLinear1d(torch.nn.Module):
    ...
    def f_real(self, u):
        f = 0.5 * u * (3 - torch.pow(u, 2)) + (1/12) * 120 * torch.pow(u, 2) * ((3/4) - 2*u +(3/2)*torch.pow(u, 2) - (1/4)*torch.pow(u, 4))
        return f
    ...
    def update(self):
        ...
        if max_f_prime > 0.8 and max_f_prime < 3:  # (0.2, 4.5) and (0.8, 3)
...
def generate_real_data(save_file, u0_file, u_fixed_file):
    ...
    # u_0_np[:1, 60:80] = 0.8
    # u_0_np[:1, 80:100] = 0.7
    # u_0_np[:1, 100:120] = 0.6
    # u_0_np[:1, 120:140] = 0.5
    # u_0_np[:1, 140:160] = 0.4
    # u_0_np[:1, 160:180] = 0.3
    # u_0_np[:1, 180:200] = 0.2
    # u_0_np[:1, 0:20] = 0.1
    # u_0 = torch.from_numpy(u_0_np)
    # u_0 = u_0.to(device)
    ...
    # u_0_np = np.zeros((batch_size, N), dtype=float)
    # u_0_np[:1, 40:90] = 1.0
    # u_0_np[1:2, 70:120] = 0.9
    # u_0_np[2:3, 60:120] = 0.8
    # u_0_np[3:4, 20:80] = 0.7
    # u_0_np[4:5, 20:80] = 0.25
    # u_0 = torch.from_numpy(u_0_np)
    # u_0 = u_0.to(device)
...
if __name__ == "__main__":
    # experiment_name = 'N_200_example_6_dt_0.1_layer_10_beta_120'
    # # experiment_name = 'N_200_example_1_dt_0.1_layer_10_beta_120_extra_test'
    # experiment_name = 'N_200_example_4_dt_0.1_layer_10_beta_120_1'
