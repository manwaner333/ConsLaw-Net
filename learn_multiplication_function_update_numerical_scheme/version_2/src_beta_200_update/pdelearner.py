...
class VariantCoeLinear1d(torch.nn.Module):
    ...
    def update(self):
        ...
        if max_f_prime > 2 and max_f_prime < 5:   #(1, 4) for example = 5
...
def generate_real_data(save_file, u0_file, u_fixed_file):
    ...
    # u_0_np[:1, 40:120] = 1.0
    # u_0_np[1:2, 70:130] = 0.9
    # u_0_np[2:3, 60:120] = 0.3
    # u_0_np[3:4, 60:120] = 0.4
    # u_0_np[4:5, 60:120] = 0.7
    # u_0 = torch.from_numpy(u_0_np)
    # u_0 = u_0.to(device)
    # batch_size = 6
    # u_0_np = np.zeros((batch_size, N), dtype=float)
...
if __name__ == "__main__":
    # experiment_name = 'N_200_example_6_dt_0.1_layer_10_beta_200'
