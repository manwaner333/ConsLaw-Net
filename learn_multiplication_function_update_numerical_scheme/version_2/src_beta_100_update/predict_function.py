...
class VariantCoeLinear1dPredict(torch.nn.Module):
    ...
    def f_real(self, u):
        ...
        # f = (2.5775002377094354)*u+(-1.6409583285126956)*u**2+(0.41365264425010473)*1+(0.24129002144660314)*u**4+(-0.20142767089964592)*u**3+(0.008457373216112842)*u**5+(0.00010175091300449782)*u**6
...
if __name__ == "__main__":
    ...
    experiment_name = 'N_200_example_1_dt_0.1_layer_10_beta_100_noise_0.03'
