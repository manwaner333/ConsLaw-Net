...
class VariantCoeLinear1dPredict(torch.nn.Module):
    ...
    def f_real(self, u):
        # f = (0.8918038919489958)*u**2+(0.8805933463183584)*1+(0.19968193802090792)*u**3+(0.019485632330143526)*u+(0.011641380473042104)*u**4+(0.00015311834808629803)*u**5+(-1.1806213390371554e-05)*u**6
        # f = (2.4430976929927324)*u**2+(-0.8719208119103714)*1+(-0.6971701637089565)*u+(-0.4004986495315911)*u**6+(-0.24803757889889919)*u**5+(-0.13751242551898343)*u**8+(-0.1272848369514466)*u**7+(0.08449174587233702)*u**3+(0.05802278062807915)*u**4+(0.005409378030792088)*u**9+(-3.354697795607583e-05)*u**10
...
if __name__ == "__main__":
    experiment_name = 'N_200_example_6_dt_0.1_layer_12_beta_negative_300'
    # N = 200
    # N = 1600
