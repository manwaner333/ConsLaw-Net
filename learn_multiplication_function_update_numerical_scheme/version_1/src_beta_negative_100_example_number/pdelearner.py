...
class VariantCoeLinear1d(torch.nn.Module):
    ...
    def update(self):
        ...
        if max_f_prime > 2 and max_f_prime < 4:
...
def generate_real_data(save_file, u0_file, u_fixed_file):
    ...
    X = 10
    dt = 0.023529
    dx = 10/200  # 10/200   # 10/1600  # 2   # 0.05
    N = 200  # 200  # 1600   # 200
    M = 0.1000
    time_steps = 200
    max_f_prime = -0.03
    ...
    #
    # u_0_np[1:2, 60:120] = 0.8
    # u_0_np[1:2, 20:60] = 0.3
    # u_0_np[1:2, 120:200] = 0.5
    #
    # u_0_np[2:3, 80:140] = 0.6
    # u_0_np[2:3, 0:80] = 1.0
    # u_0_np[2:3, 140:200] = 0.1
    #
    # u_0_np[3:4, 0:60] = 0.4
    # u_0_np[3:4, 60:110] = 0.65
    # u_0_np[3:4, 110:200] = 0.85
    #
    # u_0_np[4:5, 60:120] = 0.3
    # u_0_np[4:5, 0:60] = 1.0
    # u_0_np[4:5, 120:180] = 0.75
    #
    # u_0_np[5:6, 20:80] = 0.7
    # u_0_np[5:6, 80:140] = 0.9
    # u_0_np[5:6, 140:180] = 0.5
    #
    # u_0_np[6:7, 20:80] = 0.9
    # u_0_np[6:7, 80:140] = 0.4
    # u_0_np[6:7, 140:200] = 0.2
    ...
    # u_0_np[4:5, 60:120] = 0.3
    # u_0_np[5:6, 20:80] = 0.7
    # u_0_np[6:7, 90:130] = 0.75
    # u_0_np[7:8, 40:100] = 0.65
    # u_0_np[8:9, 10:80] = 0.85
    # u_0_np[9:10, 60:100] = 0.9
    # u_0_np[10:11, 50:90] = 0.95


    # u_0_np[:1, 0:60] = 1.0
    # u_0_np[1:2, 20:80] = 0.9
    # u_0_np[2:3, 40:100] = 0.8
    # u_0_np[3:4, 60:120] = 0.7
    # u_0_np[4:5, 80:140] = 0.6
    # u_0_np[5:6, 0:60] = 0.5
    # u_0_np[6:7, 20:80] = 0.4
    # u_0_np[7:8, 40:100] = 0.3
    # u_0_np[8:9, 60:120] = 0.2
    # u_0_np[9:10, 0:60] = 0.1


    u_0_np = np.zeros((batch_size, N), dtype=float)
    u_0_np[:1, 30:130] = 1.0

    u_0_np[1:2, 30:130] = 0.9
    u_0_np[1:2, 0:30] = 0.4
    u_0_np[1:2, 130:200] = 0.4

    u_0_np[2:3, 30:130] = 0.8
    u_0_np[2:3, 0:30] = 0.3
    u_0_np[2:3, 130:200] = 0.3

    u_0_np[3:4, 30:130] = 0.7
    u_0_np[3:4, 0:30] = 0.2
    u_0_np[3:4, 130:200] = 0.2

    u_0_np[4:5, 30:130] = 0.6
    u_0_np[4:5, 0:30] = 0.1
    u_0_np[4:5, 130:200] = 0.1
...
if __name__ == "__main__":
    experiment_name = 'N_200_example_5_dt_0.1_layer_10_beta_negative_100_adjust_du'
