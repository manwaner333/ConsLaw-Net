...
def f_predict_function(u):
    ...
    f = (2.014015359812084)*u+(-0.8498168721583168)*u**2+(0.40972032861640134)*1+(-0.22645810483839576)*u**3+(0.0508278613047442)*u**4+(0.006598350613345363)*u**5+(0.00021649037796779604)*u**6+(1.9967108552160806e-06)*u**7
    return f
...
if __name__ == "__main__":
    test_data_name = 'N_200_example_1_dt_0.1_layer_10_beta_50'  # _no_stableloss
    #
    time_steps_real = 103    # 51, 103
    time_steps_predict = 117  # 59, 119
    cell_numbers = 200
    example_index = 0
    time = 2
