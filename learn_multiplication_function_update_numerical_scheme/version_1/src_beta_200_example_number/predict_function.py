...
class VariantCoeLinear1dPredict(torch.nn.Module):
    ...
    def update(self):
        ...
        if max_f_prime > 0.2 and max_f_prime < 10:
...
def generate_predict_data_cell_200(save_file):
    ...
    # u_0_np[5:6, 20:80] = 0.3

    u_0_np[:1, 0:60] = 1.0
    u_0_np[1:2, 60:120] = 0.8
    u_0_np[1:2, 80:140] = 0.7
    u_0_np[2:3, 80:140] = 0.6
    u_0_np[3:4, 0:60] = 0.4
    u_0_np[4:5, 60:120] = 0.3
    u_0_np[5:6, 20:80] = 0.1
    u_0 = torch.from_numpy(u_0_np)
    u_0 = u_0.to(device)
    # # 引入 u_fixed, 用来计算max_f_prime
    # du = 1.2/502
...
if __name__ == "__main__":
    experiment_name = 'N_200_example_7_dt_0.1_layer_10_beta_200_adjust_du'
    N = 200
    # N = 1600
    real_data_file = 'data/' + experiment_name + '_U_cell_' + str(N) + '.npy'
    predict_data_file = 'data/' + 'predict_' + experiment_name + '_U_cell_' + str(N) + '.npy'
