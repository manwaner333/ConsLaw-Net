...
def f_predict_function(u):
    ...
    # f = (-9.03786884300144)*u**3+(3.3129180617462026)*u**4+(2.749990540893287)*u+(2.569167518313604)*u**2+(1.2610595455572302)*u**5+(0.2776772834537674)*1+(0.1318986710897431)*u**6+(0.005632101657091752)*u**7+(8.600604336844416e-05)*u**8
    # f = (3.688527961867629)*u+(-3.0867370705761945)*u**2+(0.2712635202567551)*1+(0.18971447159139998)*u**4+(0.03799162641881421)*u**3+(0.013465908216982785)*u**5+(0.00032677376168238685)*u**6+(3.032896701297645e-06)*u**7
    f = (-10.999840969792047)*u**3+(4.346287172518214)*u**4+(3.8361505528004325)*u**2+(2.450141705915168)*u+(1.2691660979950996)*u**5+(0.33904836048010234)*1+(0.10790567734997773)*u**6+(0.0037706737245289043)*u**7+(4.716520736516874e-05)*u**8
    return f
...
if __name__ == "__main__":
    test_data_name = 'N_200_example_7_dt_0.1_layer_10_beta_200_adjust_du'  # _no_stableloss

    time_steps_real = 88  # 177
    time_steps_predict = 108  # 217
    cell_numbers = 200
    example_index = 0
    time = 1
