...
class VariantCoeLinear1dPredict(torch.nn.Module):
    ...
    def f_real(self, u):
        f = (1.4621516046531837)*u+(-0.6694938697466343)*u**3+(0.5374179939715152)*1+(0.14122416362626805)*u**4+(0.07524337194366823)*u**2+(0.008372199840035637)*u**5+(0.00014580407262172707)*u**6
        return f
...
if __name__ == "__main__":
    experiment_name = 'N_200_example_1_dt_0.1_layer_10_beta_negative_20'
    N = 200
    # N = 1600
