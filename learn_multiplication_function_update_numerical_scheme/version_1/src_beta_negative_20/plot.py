...
def f_real_function(u):
    f = 0.5 * u * (3 - np.power(u, 2)) + (1/12) * (-20) * np.power(u, 2) * ((3/4) - 2*u +(3/2)*np.power(u, 2) - (1/4)*np.power(u, 4))
    return f
...
if __name__ == "__main__":
    test_data_name = 'N_200_example_1_dt_0.1_layer_10_beta_negative_20'  # _no_stableloss

    time_steps_real = 99     # 49, 99
    time_steps_predict = 79  # 39, 79
    cell_numbers = 200
    example_index = 0
    time = 2
