...
class VariantCoeLinear1dPredict(torch.nn.Module):
    ...
    def f_real(self, u):
        f = (-6.388025803482927)*u**3+(2.421025053517315)*u**4+(2.2551640165006037)*u+(1.8924580334287413)*u**2+(0.7720858416508105)*u**5+(0.37928718353420693)*1+(0.06988549349167283)*u**6+(0.00257930149765841)*u**7+(3.3911689846891194e-05)*u**8
        return f
...
if __name__ == "__main__":
    experiment_name = 'N_200_example_1_dt_0.1_layer_10_beta_120'
    N = 200
    # N = 1600
