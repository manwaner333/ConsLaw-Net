...
def f_predict_function(u):
    # f = (1.5281429503106354)*u+(0.5180902743727152)*1+(-0.286860401093736)*u**3+(-0.28094507135084584)*u**2+(0.0673556741425546)*u**4+(0.0018022353513726698)*u**5+(1.4458591102430725e-05)*u**6
    f = (1.5232374682825194)*u+(0.5225883664267724)*1+(-0.4708274960952874)*u**2+(-0.039213180527983914)*u**3+(0.033001611728790015)*u**4+(-0.002436377938191222)*u**5+(6.131976504783796e-05)*u**6
    return f
...
if __name__ == "__main__":
    test_data_name = 'N_200_example_1_dt_0.1_layer_10_beta_negative_50'  # _no_stableloss

    time_steps_real = 127    # 63, 127
    time_steps_predict = 87  # 43  # 87
    cell_numbers = 200
    example_index = 0
    time = 2
