...
def f_predict_function(u):
    # f = (2.052846636980929)*u+(-0.9432208281910771)*u**2+(0.4384505844992237)*1+(-0.1406592852309841)*u**3+(0.03066132442651987)*u**4+(0.003580653935085972)*u**5+(9.1576128953439e-05)*u**6
    # f = (2.0543727367743227)*u+(-0.9793266908029702)*u**2+(0.5052633913648727)*1+(-0.09492251199908777)*u**3+(0.030665559308145178)*u**4+(0.0026448622552764085)*u**5+(5.597561168229676e-05)*u**6
    f = (2.0410904653376845)*u+(-0.9084787536806251)*u**2+(0.41399497925046697)*1+(-0.18435859104255528)*u**3+(0.056414584232414675)*u**4+(0.0052391049987727065)*u**5+(0.00013524757495871268)*u**6+(1.0609466165252485e-06)*u**7
    return f
...
if __name__ == "__main__":
    test_data_name = 'N_200_example_2_dt_0.1_layer_10_beta_50'  # _no_stableloss

    # time_steps_real = 51   # 51, 103
    # time_steps_predict = 59 # 59, 119
    # cell_numbers = 200
    # example_index = 0
    # time = 1
