...
def f_predict_function(u):
    ...
    molecular = (-0.9831515075411446)*u+(0.2114695452366314)*u**2+(0.17307586611725867)*1+(0.0055127818887980625)*u**3+(5.504804581461221e-06)*u**4
    denominator = (1.5436433993980838)*u+(-1.1485125630762434)*u**2+(-1.029297781777792)*1+(-0.02809669812874878)*u**3+(-2.805604061668959e-05)*u**4
...
if __name__ == "__main__":
    ...
    test_data_name = 'N_1000_example_3_dt_0.1_layer_10_beta_0.5_no_alpha'
    ...
    time_point_list = [0, 28, 56, 84, 112, 140, 167, 195, 223, 251]
