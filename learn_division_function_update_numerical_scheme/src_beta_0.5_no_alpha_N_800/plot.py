...
def f_predict_function(u):
    ...
    molecular = (-1.3255665789855526)*u+(0.7132340770119191)*1+(-0.3502940447244993)*u**2+(-0.03233650048316385)*u**3+(-0.0005893824201438026)*u**4
    denominator = (-3.1091287755850265)*u**2+(2.129316937539856)*u+(-1.1467107875906382)*1+(-0.4980224043390442)*u**3+(-0.009077223743119847)*u**4
...
if __name__ == "__main__":
    ...
    # test_data_name = 'N_400_example_2_dt_0.1_layer_10_beta_0.5_no_alpha_noise_0.03'
    # test_data_name = 'N_400_example_1_dt_0.6_layer_25_beta_0.5_noise_0.03_1'
    test_data_name = 'N_800_example_2_dt_0.1_layer_10_beta_0.5_no_alpha'

    real_data_file = 'data/' + test_data_name + '_U' + '.npy'
    predict_data_file = 'data/' + 'predict_' + test_data_name + '_U' + '.npy'

    real_time_step = 332    # 332(1.5)   # 446 (2.0)
    predict_time_step = 332   # 332(1.5)   # 446 (2.0)
    time = 15
    example_index = 1
    ...
    time_point_list = [0, 22, 45, 67, 89, 112, 134, 156, 179, 201]
