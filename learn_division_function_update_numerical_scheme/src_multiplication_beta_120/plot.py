...
def f_predict_function(u):
    molecular = (1.8132883795184669)*u**2+(-1.5864325070189718)*u+(0.6710887540039095)*1+(-0.03689504530190985)*u**3+(-0.0004504084035042021)*u**4
    denominator = (-2.342719539204636)*u**2+(0.5967943906437916)*u+(-0.4833366294831388)*1+(0.04867055014907031)*u**3+(0.0005941617529110122)*u**4
...
if __name__ == "__main__":
    ...
    test_data_name = 'N_200_example_2_dt_0.1_layer_10_beta_120'
