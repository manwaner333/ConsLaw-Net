...
def f_predict_function(u):
    ...
    molecular = (-0.9857557865051734)*u+(0.12440199692952472)*u**2+(0.04160054363004936)*1+(0.012875875158080167)*u**3+(-1.9705416071823295e-05)*u**4
    denominator = (1.7426507084977754)*u+(-1.232568061490445)*1+(-1.1983442422753312)*u**2+(-0.08846418355082404)*u**3+(0.00013538680073557456)*u**4
...
if __name__ == "__main__":
    ...
    test_data_name = 'N_400_example_2_dt_0.1_layer_10_beta_0.5_no_alpha_noise_0.05'
    ...
    # time_point_list = [0, 11, 22, 34, 45, 56, 67, 78, 90, 101]
