...
class VariantCoeLinear1d(torch.nn.Module):
    ...
    def update(self):
        ...
        if 0.001 < max_f_prime  and max_f_prime < 3:  #(0.04, 3)
...
def generate_real_data(save_file, u0_file, u_fixed_file):
    ...
    # u_0_np[:1, 640:960] = 0.8  # N = 1600
    # u_0_np[:1, 400:600] = 0.8  # N = 1000
...
if __name__ == "__main__":
    experiment_name = 'N_1000_example_1_dt_0.6_layer_20_beta_0.5_1'
