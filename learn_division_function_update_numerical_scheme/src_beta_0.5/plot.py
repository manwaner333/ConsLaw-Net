...
def f_predict_function(u):
    ...
    # molecular = (-0.6973738404428048)*u+(0.42869507803784024)*1+(0.0014281131549658706)*u**2
    # denominator = (-0.7787458260410193)*1+(-0.036943929215460455)*u+(-0.0290148138062595)*u**2+(-1.0764957166747423e-05)*u**3
    ...
    molecular = (-0.9402910562393393)*u+(0.4267279672256684)*1+(0.052109863737495904)*u**2+(3.2741455378042366e-05)*u**3
    denominator = (-0.6527146382651269)*1+(-0.2525242166567814)*u**2+(-0.058506009760469956)*u+(-0.0001571958016130148)*u**3
...
if __name__ == "__main__":
    ...
    test_data_name = 'N_400_example_1_dt_0.6_layer_25_beta_0.5_noise_0.03'
